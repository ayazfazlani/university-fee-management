<div>
  <div>
      ...
      {{-- voucher model  --}}
      <div wire:ignore.self class="modal fade" id="voucherModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if($selectedInstallmentId)
                        <livewire:invoice-system.installment-voucher :installment-id="$selectedInstallmentId" wire:key="voucher-{{ $selectedInstallmentId }}" />
                    @endif
                </div>
            </div>
        </div>
                          ...
                          <tbody>
                              @foreach($installments as $installment)
                                  <tr>
                                      ...
                                      <td>
                                        <button class="btn btn-sm btn-info" wire:click="viewVoucher({{ $installment->id }})">View</button>
  ...
  <script>
      ...
      $wire.on('showVoucherModal', () => {
            $('#voucherModal').modal('show');
        });

        $wire.on('hideVoucherModal', () => {
