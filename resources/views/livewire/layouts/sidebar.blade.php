    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
                ...
                <span class="app-brand-text demo menu-text fw-bold ms-2">Fee Portal</span>
            </a>
        ...
        <ul class="menu-inner py-1">
            @role(['Super Admin', 'HOD', 'Admin'])
                <li class="menu-item active">
                    <a href="{{ route('sessions') }}" class="menu-link">
                        ...
                        <div class="text-truncate" data-i18n="Branches">Sessions</div>
                    </a>
                </li>

                <li class="menu-item">
                    <a href="{{ route('section') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-group"></i>
                        <div class="text-truncate" data-i18n="Staff">Section</div>
                    </a>
                </li>
            @endrole
            @role(['Super Admin', 'HOD', 'Admin', 'CR'])
                <li class="menu-item">
            ...
            <li class="menu-item">
                <a href="{{ route('students') }}" class="menu-link">
                    ...
                    <div class="text-truncate" data-i18n="Doctors">Students</div>
                </a>
            </li>
            <!-- Fee Management -->
            <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    ...
                    <div class="text-truncate" data-i18n="Fee Management">Fee Management</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item">
