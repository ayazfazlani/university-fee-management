            ...
            <div class="modal-dialog modal-dialog-centered">
                <form wire:submit.prevent="{{ $selectedVoucher ? 'update' : 'store' }}" class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="voucherNumber" wire:model="voucherNumber" class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" id="voucherImage" wire:model="voucherImage" class="form-control" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" id="paymentDate" wire:model="paymentDate" class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="semesterId" wire:model="semesterId" class="form-control">
                    ...
                    <div class="modal-footer gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">{{ $selectedVoucher ? 'Update' : 'Save'
                            }}</button>
                    </div>
                </form>
            </div>
                        ...
                        <div class="border rounded p-3 mb-3">
                            ...
                            {{-- <div class="text-center mb-2">
                                <img src="{{ asset('storage/' . $voucherDetails->voucher_image) }}"
                                    class="img-fluid rounded shadow-sm" alt="Voucher Image"
                            ...
                            <table class="table table-sm table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($voucherDetails->payment_date)->format('d M, Y') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><i class="bi bi-cash"></i> Amount:</strong></td>
                                        <td><span class="fw-bold text-success">Rs. {{
                                                number_format($voucherDetails->amount, 2) }}</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge {{ $voucherDetails->status === 'Paid' ? 'bg-success' : 'bg-warning text-dark' }}">
                                                {{ $voucher->status }}
                                            </span>
                                        </td>
                                    </tr>
                                ...
                                <tr wire:key="{{ $voucher->id }}">
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-primary"
                                            wire:click="show({{ $voucher->id }})">view</button>
                                        <button class="btn btn-sm btn-primary"
                                            wire:click="edit({{ $voucher->id }})">Edit</button>
                                        <button class="btn btn-sm btn-danger"
                                            wire:click="delete({{ $voucher->id }})">Delete</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
