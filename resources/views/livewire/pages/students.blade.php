            ...
            <div class="modal-dialog modal-dialog-centered">
                <form wire:submit.prevent="{{ $selectedStudent ? 'update' : 'store' }}" class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="userId" wire:model="userId" class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="rollNo" wire:model="rollNo" class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" id="admissionDate" wire:model="admissionDate" class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" id="integer" wire:model="amount" class="form-control"
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="sectionId" wire:model="sectionId" class="form-control">
                    ...
                    <div class="modal-footer gap-2">
                        ...
                        <button type="submit"
                            class="btn btn-primary">{{ $selectedStudent ? 'Update' : 'Save' }}</button>
                    </div>
                </form>
            </div>
        </div>
