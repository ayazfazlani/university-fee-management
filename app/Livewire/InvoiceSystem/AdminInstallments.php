...
class AdminInstallments extends Component
{
    public $installments = [], $amount, $dueDate, $feeStructureId, $selectedInstallment, $structure, $data;


    public function mount()
    {
        // Fetch installments for the given fee structure ID
        $this->installments = Installments::get();
    ...
    //     $this->installments = Installments::all(); // Use Installment instead of Installments
    //     $this->structure = FeeStructures::with('patient')->get();
    // }
    ...
    {
        $installment = Installments::find($id); // Use Installment instead of Installments
        $installment->delete();
        $this->mount();
    ...
    {
        return view(
            'livewire.invoice-system.admin-installments',
            [
